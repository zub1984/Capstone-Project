...
public class ListManipulator {
        ...
        synchronized (this) {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    StockChange stock = Utility.getStockFromCursor(cursor);
     ...
     * @param stock
     */
    public void addItemToTop(StockChange stock) {
        synchronized (this) {
            stock.setId(mUniqueId++);
     ...
     * @param stock
     */
    public void addItemToBottom(StockChange stock) {
        synchronized (this) {
            stock.setId(mUniqueId++);
            mShownList.add(stock);
     ...
     * @param stock
     */
    public void addItemToPosition(int position, StockChange stock) {
        synchronized (this) {
            stock.setId(mUniqueId++);
     ...
     * @return
     */
    public StockChange getItem(int position) {
    ...
    public void moveItem(int fromPosition, int toPosition) {
        synchronized (this) {
            StockChange stock = mShownList.remove(fromPosition);
    ...
    public void sort(int sortPreference) {
        Comparator<StockChange> comparator;
    ...
    private static class ComparatorAscAlphabetical implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return lhs.getSymbol().compareTo(rhs.getSymbol());
        }
    }

    private static class ComparatorDescAlphabetical implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return -lhs.getSymbol().compareTo(rhs.getSymbol());
        }
    ...
    private static class ComparatorAscStreak implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
    ...
    private static class ComparatorDescStreak implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return -Utility.compare(lhs.getStreak(), rhs.getStreak());
        }
    ...
    private static class ComparatorAscChangeDollar implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
    ...
    private static class ComparatorDescChangeDollar implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return -Float.compare(lhs.getChangeDollar(), rhs.getChangeDollar());
        }
    ...
    private static class ComparatorAscChangePercent implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
    ...
    private static class ComparatorDescChangePercent implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return -Float.compare(lhs.getChangePercent(), rhs.getChangePercent());
        }
    ...
    private static class ComparatorAscRecentClose implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
    ...
    private static class ComparatorDescRecentClose implements Comparator<StockChange>{
        @Override
        public int compare(StockChange lhs, StockChange rhs) {
            return -Float.compare(lhs.getRecentClose(), rhs.getRecentClose());
        }
