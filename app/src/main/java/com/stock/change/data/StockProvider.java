...
public class StockProvider extends ContentProvider {
    ...
    public Bundle call(@NonNull String method, String arg, Bundle extras) {
        if (extras != null) {
            ...
            String sessionId = extras.getString(Constants.KEY_SESSION_ID);
    ...
    private void performLoadSymbol(ArrayList<ContentProviderOperation> ops, String sessionId) {
        List<StockChange> stockList = loopThroughOperations(ops);
    ...
    private void performRefresh(ArrayList<ContentProviderOperation> ops, String sessionId) {
        ...
        if (getContext() != null) {
            getContext().sendBroadcast(new Intent(Constants.ACTION_DATA_UPDATED));
        }
    ...
    private List<StockChange> loopThroughOperations(ArrayList<ContentProviderOperation> ops) {
        List<StockChange> stockList = new ArrayList<>();
        Cursor cursor = null;
