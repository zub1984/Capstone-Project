...
public class DetailService extends Service {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String symbol = intent.getStringExtra(Constants.KEY_DETAIL_SYMBOL);
                    ...
                    if (isDetailDataExist(symbol)) {
                        EventBus.getDefault().postSticky(new LoadDetailFinishedEvent(
                                intent.getStringExtra(Constants.KEY_SESSION_ID),
                                intent.getStringExtra(Constants.KEY_DETAIL_SYMBOL),
                                true));
     ...
     * @return historicaldetails of years
     * @throws IOException
     */
    private ContentValues getDetailValues(String symbol) throws IOException {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                prevStreakEndDate = cursor.getLong(Constants.indexPrevStreakEndDate);
                prevStreakEndPrice = cursor.getFloat(Constants.indexPrevStreakEndPrice);
                currentStreak = cursor.getInt(Constants.indexStreak);
                ...
                List<HistoricalQuote> historyList = stock.getHistory(getFromCalendarDate(), getToCalendarDate(prevStreakEndDate), Interval.DAILY);
    ...
    /**
     * get 1 year back date.
     */
    private Calendar getFromCalendarDate() {
     ...
     * get to date .
     */
    private Calendar getToCalendarDate(Long prevStreakEndDate) {
     ...
     *
     * @param chartMap list object of stock's streak frequency
     * @param streak   value
     */
