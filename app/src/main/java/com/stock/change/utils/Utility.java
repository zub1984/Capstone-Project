...
public class Utility {
     ...
     *
     * @param recentClose        StockChange's recent close
    ...
    /**
     * Extracts the {@link StockChange} from the cursor's current position.
     *
     * @param cursor
     * @return
     */
    public static StockChange getStockFromCursor(Cursor cursor) {
